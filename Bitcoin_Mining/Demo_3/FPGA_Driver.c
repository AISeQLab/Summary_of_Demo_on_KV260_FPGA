...
/*  ... 4GB(including REGS) */
#define LMM_BASE_PHYS	 0x0000000400000000LL
/*  ... fixed */
...
struct fpga { /* host status of U2BCA */
  ...
  // Uchar lmmd[AMAP_DEPTH][EMAX_WIDTH]; /* chip#7,6,..,0:clean, 1:dirty, exec  store ?  1, drainl  0 */
...
int fpga_open()
{
  ...
  for (dir = 0; dir < num_dirs; ++dir) {
	...
	return -1;
      ...
      MY_IP_info.reg_phys = REG_BASE_PHYS; // 0x0000000400000000LL
	  MY_IP_info.ctx_pe_offset = CTX_PE_BASE_IP >> 2; // 0x0000000001000000LL >> 2 = 0x0000000000400000LL Revising address for PIO PE CTX transfer 32-bit
	  ...
	  
	  MY_IP_info.ctx_rc_offset = CTX_RC_BASE_IP >> 3; // 0x0000000002000000LL >> 3 = 0x0000000000400000LL Revising address for PIO RC CTX transfer 64-bit quan trong
      MY_IP_info.pio_64_mmap = (U64*)mmap(NULL, REG_MMAP_SIZE, PROT_READ|PROT_WRITE, MAP_SHARED, fd_reg, 0); /* 4GB */
      if (MY_IP_info.pio_64_mmap == MAP_FAILED) {
		printf("pio_64_mmap failed. errno=%d\n", errno);
		return -1;
      }
      
	  MY_IP_info.ctx_im_offset = CTX_IM_BASE_IP >> 2;  // 0x0000000003000000LL >> 2 = 0x0000000000C00000LL Revising address for PIO IM CTX transfer 32-bit
      MY_IP_info.ctx_im_mmap = (U32*)mmap(NULL, REG_MMAP_SIZE, PROT_READ|PROT_WRITE, MAP_SHARED, fd_reg, 0); /* 4GB */
      if (MY_IP_info.ctx_im_mmap == MAP_FAILED) {
