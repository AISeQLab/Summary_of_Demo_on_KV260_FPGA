...
int main(){
	...
	for (i = 0; i < LOOP; i++){
		if( i == 0){
			...
			exe(OP_NOP, 0, PE_out[12],/*ALU in*/ 0,0,0,0, /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[8][4],PE_out[8][5], PE_out[8][6], PE_out[8][7]);
			exe(OP_NOP, 0, PE_out[13],/*ALU in*/ 0,0,0,0, /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[9][4],PE_out[9][5], PE_out[9][6], PE_out[9][7]);
			exe(OP_NOP, 0, PE_out[14], /*ALU in*/ 0,0,0,0, /*BUFF 16to1 in*/ PE_out[10][2], PE_out[10][3], PE_out[11][2], PE_out[11][3], /*BUFF 8to1 in*/ PE_out[10][4], PE_out[10][5], PE_out[10][6], PE_out[10][7]);
			exe(OP_NOP, 0, PE_out[15], /*ALU in*/ PE_out[9][0],PE_out[9][1],PE_out[10][0],PE_out[10][1], /*BUFF 16to1 in*/ PE_out[8][0],PE_out[8][1], PE_out[11][0], PE_out[11][1], /*BUFF 8to1 in*/ 0, 0, 0, 0);		
			...
			exe(OP, 0, PE_out[4],/*ALU in*/ PE_out[0][0],PE_out[0][1],PE_out[0][4],PE_out[0][5], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			exe(OP, 0, PE_out[5],/*ALU in*/ PE_out[1][0],PE_out[1][1],PE_out[0][6],PE_out[0][7], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			exe(OP, 0, PE_out[6],/*ALU in*/ PE_out[2][0],PE_out[2][1],PE_out[1][4],PE_out[1][5], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			exe(OP, 0, PE_out[7],/*ALU in*/ PE_out[3][0],PE_out[3][1],PE_out[1][6],PE_out[1][7], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			// /*** row 2 ***///
			exe(OP_NOP, 0, PE_out[8],/*ALU in*/  PE_out[4][2] ,0,0,PE_out[4][1], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			exe(OP_NOP, 0, PE_out[9],/*ALU in*/  PE_out[5][2] ,0,0,PE_out[5][1], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			exe(OP_NOP, 0, PE_out[10],/*ALU in*/ PE_out[6][2] ,0,0,PE_out[6][1], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			exe(OP_NOP, 0, PE_out[11],/*ALU in*/ PE_out[7][2] ,0,0,PE_out[7][1], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			// /*** row 3 ***///
			exe(OP_NOP, 0, PE_out[12],/*ALU in*/ PE_out[8] [1],0,0,PE_out[8] [2],/*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			exe(OP_NOP, 0, PE_out[13],/*ALU in*/ PE_out[9] [1],0,0,PE_out[9] [2],/*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			exe(OP_NOP, 0, PE_out[14],/*ALU in*/ PE_out[10][1],0,0,PE_out[10][2],/*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			exe(OP_NOP, 0, PE_out[15],/*ALU in*/ PE_out[11][1],0,0,PE_out[11][2],/*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
		}
		else if(i == 66){
			...
			if( i == 1) {
				...
				exe(OP, 0, PE_out[0],/*ALU in*/ PE_out[12][8],PE_out[14][4],0,PE_out[14][8], /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[12][8],PE_out[12][9], PE_out[12][10], PE_out[12][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_XOR,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_XOR);
				exe(OP, 0, PE_out[1],/*ALU in*/ PE_out[12][8],0,PE_out[12][9],PE_out[12][10], /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[13][8], PE_out[13][9], PE_out[13][10], PE_out[13][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_XOR,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_XOR);
				exe(OP, 0, PE_out[2],/*ALU in*/ PE_out[13][8],0,PE_out[13][9],PE_out[13][10], /*BUFF 16to1 in*/ PE_out[14][4], PE_out[14][5], PE_out[14][6], PE_out[14][7], /*BUFF 8to1 in*/ PE_out[14][8], PE_out[14][9], PE_out[14][10], PE_out[14][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_XOR,/*SRU1*/OP_ROL,/*SRU1_IM*/15,/*SRU2*/OP_NOP,/*SRU2_IM*/0,/*LU3*/OP_XOR);	// E^F^G
				exe(OP, 0, PE_out[3],/*ALU in*/ PE_out[15][1], PE_out[14][4], 0, PE_out[14][11], /*BUFF 16to1 in*/ PE_out[15][0], PE_out[15][1], PE_out[15][2], PE_out[15][3], /*BUFF 8to1 in*/ PE_out[15][4], PE_out[15][5],PE_out[15][6], PE_out[15][7]);

				// /*** row 1 ***///
				// OP_Immidiate = K[i-1];
				/*--*/OP = BASIC_OP(/*AU*/OP_ADD3,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/7,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_XOR);
				exe(OP, K[i-1], PE_out[4],/*ALU in*/ PE_out[0][2],0, PE_out[1][8], PE_out[0][2], /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[0][8], PE_out[0][9], PE_out[0][10], PE_out[0][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_ADD3,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_XOR);
				exe(OP, 0, PE_out[5],/*ALU in*/ PE_out[0][1],PE_out[0][11],PE_out[1][1],0, /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[1][8], PE_out[1][9], PE_out[1][10], PE_out[1][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_ADD3,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
				exe(OP, 0, PE_out[6],/*ALU in*/ PE_out[2][1],PE_out[1][11], PE_out[2][4], 0, /*BUFF 16to1 in*/ PE_out[2][4], PE_out[2][5], PE_out[2][6], PE_out[2][7], /*BUFF 8to1 in*/ PE_out[2][8], PE_out[2][9], PE_out[2][10], PE_out[2][11]);
				...
				exe(OP, 0, PE_out[7],/*ALU in*/ PE_out[3][1], 0, PE_out[3][1], PE_out[3][1], /*BUFF 16to1 in*/ PE_out[3][8], PE_out[3][9], PE_out[3][6], PE_out[3][7], /*BUFF 8to1 in*/ PE_out[3][4], PE_out[3][5], PE_out[3][10], PE_out[3][11]);


				// /*** row 2 ***///
				// OP_Immidiate = K[i-1];
				/*--*/OP = BASIC_OP(/*AU*/OP_ADD2,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/0,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
				exe(OP, 0, PE_out[8],/*ALU in*/ PE_out[4][1],PE_out[5][2], 0, 0, /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[4][8], PE_out[4][9], PE_out[4][10], PE_out[4][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/9,/*SRU2*/OP_ROL,/*SRU2_IM*/19,/*LU3*/OP_NOP); // Find new C and new G
				exe(OP, 0, PE_out[9],/*ALU in*/ PE_out[4][9],0, 0, PE_out[5][9], /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[5][8], PE_out[5][9], PE_out[5][10], PE_out[5][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_ADD2,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
				exe(OP, 0, PE_out[10],/*ALU in*/ PE_out[4][2],PE_out[6][2],PE_out[7][4],0, /*BUFF 16to1 in*/ PE_out[6][4], PE_out[6][5], PE_out[6][6], PE_out[6][7], /*BUFF 8to1 in*/ PE_out[6][8], PE_out[6][9], PE_out[6][10], PE_out[6][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_XOR,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/0,/*SRU2*/OP_ROL,/*SRU2_IM*/7,/*LU3*/OP_XOR);
				exe(OP, 0, PE_out[11],/*ALU in*/ PE_out[7][0], 0, PE_out[7][1], PE_out[6][7],/*BUFF 16to1 in*/ PE_out[7][4], PE_out[7][5], PE_out[7][6], PE_out[7][7], /*BUFF 8to1 in*/ PE_out[7][8], PE_out[7][9], PE_out[7][10], PE_out[7][11]);


				// /*** row 3 ***///
				// OP_Immidiate = K[i-1];
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/0,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
				exe(OP, 0, PE_out[12],/*ALU in*/ 0, 0, PE_out[10][2], 0, /*BUFF 16to1 in*/ PE_out[8][2],PE_out[8][8],PE_out[9][2],PE_out[8][10], /*BUFF 8to1 in*/ PE_out[8][8], PE_out[8][9], PE_out[8][10], PE_out[8][11]);	// Wait C
				// printf("\n%08x\n", P0(0xc067debb));
				/*--*/OP = CUSTOM_OP(OP_P0);
				exe(OP, 0, PE_out[13],/*ALU in*/ PE_out[10][2],0,0,0, /*BUFF 16to1 in*/ 0,PE_out[9][8],PE_out[9][1],PE_out[9][10], /*BUFF 8to1 in*/ PE_out[9][8], PE_out[9][9], PE_out[9][10], PE_out[9][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/0,/*SRU2*/OP_NOP,/*SRU2_IM*/0,/*LU3*/OP_NOP); 
				exe(OP, 0, PE_out[14],/*ALU in*/ 0,0, 0, 0, /*BUFF 16to1 in*/ PE_out[10][5], PE_out[10][6], PE_out[10][7], PE_out[10][0], /*BUFF 8to1 in*/ PE_out[10][8], PE_out[10][9], PE_out[10][10], PE_out[10][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_XOR,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/0,/*SRU2*/OP_NOP,/*SRU2_IM*/0,/*LU3*/OP_NOP);
				exe(OP, 0, PE_out[15],/*ALU in*/ PE_out[11][1], 0, PE_out[11][6], 0,/*BUFF 16to1 in*/ PE_out[11][5], PE_out[11][6], PE_out[11][7], 0,/*BUFF 8to1 in*/ PE_out[11][8], PE_out[11][9], PE_out[11][10], PE_out[11][11]); // 0xd317e0c4 ^ 0x0000000a
				...
				// /**/OP_Immidiate = K[i-1];
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_XOR,/*SRU1*/OP_ROL,/*SRU1_IM*/12,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
				exe(OP, 0, PE_out[0],/*ALU in*/ PE_out[12][4],PE_out[14][4],0,PE_out[14][9], /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[12][4],PE_out[12][5], PE_out[12][6], PE_out[12][7]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_XOR,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_XOR);
				exe(OP, 0, PE_out[1],/*ALU in*/ PE_out[12][4],0,PE_out[12][5],PE_out[12][6], /*BUFF 16to1 in*/ PE_out[13][0],0,0,0, /*BUFF 8to1 in*/ 0, PE_out[13][5], PE_out[13][6], PE_out[13][7]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_XOR,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_XOR);
				exe(OP, 0, PE_out[2],/*ALU in*/ PE_out[13][0],0,PE_out[13][5],PE_out[13][6], /*BUFF 16to1 in*/ PE_out[14][4], PE_out[14][5], PE_out[14][6], PE_out[14][8], /*BUFF 8to1 in*/ PE_out[14][9], PE_out[14][10], PE_out[14][11], PE_out[14][7]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_XOR,/*SRU1*/OP_ROL,/*SRU1_IM*/15,/*SRU2*/OP_NOP,/*SRU2_IM*/0,/*LU3*/OP_XOR);	// E^F^G
				exe(OP, 0, PE_out[3],/*ALU in*/ PE_out[15][10], PE_out[14][4], 0, PE_out[14][7], /*BUFF 16to1 in*/ PE_out[15][4], PE_out[15][5], PE_out[15][6], PE_out[15][2], /*BUFF 8to1 in*/ PE_out[15][8], PE_out[15][9],PE_out[15][10], PE_out[15][11]);

				// /*** row 1 ***///
				// OP_Immidiate = K[i-1];
				/*--*/OP = BASIC_OP(/*AU*/OP_ADD3,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/7,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_XOR);
				exe(OP, K[i-1], PE_out[4],/*ALU in*/ PE_out[0][2],0, PE_out[1][4], PE_out[0][2], /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[0][8], PE_out[0][9], PE_out[0][10], PE_out[0][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_ADD3,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_XOR);
				exe(OP, 0, PE_out[5],/*ALU in*/ PE_out[0][1],PE_out[0][11],PE_out[1][1],0, /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[1][4], PE_out[1][9], PE_out[1][10], PE_out[1][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_ADD3,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
				exe(OP, 0, PE_out[6],/*ALU in*/ PE_out[2][1],PE_out[1][11], PE_out[2][4], 0, /*BUFF 16to1 in*/ PE_out[2][4], PE_out[2][5], PE_out[2][6], PE_out[2][7], /*BUFF 8to1 in*/ PE_out[2][8], PE_out[2][9], PE_out[2][10], PE_out[2][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/15,/*SRU2*/OP_ROL,/*SRU2_IM*/23,/*LU3*/OP_XOR);
				// printf("6164e387 ROTL 15 = %08x, 6164e387 ROTL 15 = %08x, XOR = %08x\n", ROTL(0x6164e387,15), ROTL(0x6164e387,23), ROTL(0x6164e387,15)^ ROTL(0x6164e387,23));
				exe(OP, 0, PE_out[7],/*ALU in*/ PE_out[3][1], 0, PE_out[3][1], PE_out[3][1], /*BUFF 16to1 in*/ PE_out[3][4], PE_out[3][5], PE_out[3][6], PE_out[3][8], /*BUFF 8to1 in*/ PE_out[3][9], PE_out[3][10], PE_out[3][11], PE_out[3][7]);
				...
				exe(OP, 0, PE_out[0],/*ALU in*/ PE_out[12][4],PE_out[14][4],0,PE_out[14][9], /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[12][4],PE_out[12][5], PE_out[12][6], PE_out[12][7]);
				/*--*/OP = CUSTOM_OP(OP_FF1);
				exe(OP, 0, PE_out[1],/*ALU in*/ PE_out[12][4],PE_out[12][5],PE_out[12][6], 0, /*BUFF 16to1 in*/ PE_out[13][0],0,0,0, /*BUFF 8to1 in*/ 0, PE_out[13][5], PE_out[13][6], PE_out[13][7]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_AND,/*LU2*/OP_NOT_AND,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_XOR);
				exe(OP, 0, PE_out[2],/*ALU in*/ PE_out[13][0],PE_out[13][0],PE_out[13][5],PE_out[13][6], /*BUFF 16to1 in*/ PE_out[14][4], PE_out[14][5], PE_out[14][6], PE_out[14][8], /*BUFF 8to1 in*/ PE_out[14][9], PE_out[14][10], PE_out[14][11], PE_out[14][7]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_XOR,/*SRU1*/OP_ROL,/*SRU1_IM*/15,/*SRU2*/OP_NOP,/*SRU2_IM*/0,/*LU3*/OP_XOR);	// E^F^G
				exe(OP, 0, PE_out[3],/*ALU in*/ PE_out[15][10], PE_out[14][4], 0, PE_out[14][7], /*BUFF 16to1 in*/ PE_out[15][4], PE_out[15][5], PE_out[15][6], PE_out[15][2], /*BUFF 8to1 in*/ PE_out[15][8], PE_out[15][9],PE_out[15][10], PE_out[15][11]);
				...
				exe(OP, K[i-1], PE_out[4],/*ALU in*/ PE_out[0][2],0, PE_out[1][4], PE_out[0][2], /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[0][8], PE_out[0][9], PE_out[0][10], PE_out[0][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_ADD3,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_XOR);
				exe(OP, 0, PE_out[5],/*ALU in*/ PE_out[0][1],PE_out[0][11],PE_out[1][0],0, /*BUFF 16to1 in*/ 0,0,0,0, /*BUFF 8to1 in*/ PE_out[1][4], PE_out[1][9], PE_out[1][10], PE_out[1][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_ADD3,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_NOP,/*SRU1_IM*/OP_NOP,/*SRU2*/OP_NOP,/*SRU2_IM*/OP_NOP,/*LU3*/OP_NOP);
				exe(OP, 0, PE_out[6],/*ALU in*/ PE_out[2][1],PE_out[1][11], PE_out[2][4], 0, /*BUFF 16to1 in*/ PE_out[2][4], PE_out[2][5], PE_out[2][6], PE_out[2][7], /*BUFF 8to1 in*/ PE_out[2][8], PE_out[2][9], PE_out[2][10], PE_out[2][11]);
				/*--*/OP = BASIC_OP(/*AU*/OP_NOP,/*LU1*/OP_NOP,/*LU2*/OP_NOP,/*SRU1*/OP_ROL,/*SRU1_IM*/15,/*SRU2*/OP_ROL,/*SRU2_IM*/23,/*LU3*/OP_XOR);
				// printf("6164e387 ROTL 15 = %08x, 6164e387 ROTL 15 = %08x, XOR = %08x\n", ROTL(0x6164e387,15), ROTL(0x6164e387,23), ROTL(0x6164e387,15)^ ROTL(0x6164e387,23));
	...
	dma_write(ROW0_MSB_BASE_PHYS,8);
	dma_write(ROW1_MSB_BASE_PHYS,8);
	dma_write(ROW2_MSB_BASE_PHYS,8);
	dma_write(ROW0_LSB_BASE_PHYS,8);
	dma_write(ROW1_LSB_BASE_PHYS,8);
	dma_write(ROW2_LSB_BASE_PHYS,8);
	...
	*(CGRA_info.ctx_pe_mmap+START_BASE_IP) = 1;
	...
	dma_read(ROW0_MSB_BASE_PHYS,8);
	dma_read(ROW0_LSB_BASE_PHYS,8);
		for (i=0; i<8; i++) {
