...
int main(){
	...
	for (i = 0; i < LOOP; i++){
		if( i == 0){
			...
			///*** row 1 ***///
			mop32(OP_LDW, 0, PE_out[4], /*ALU in*/ 0,0,0,0, /*BUFF 16to1 in*/ PE_out[1][0], PE_out[0][1], PE_out[1][0], PE_out[1][1], /*BUFF 8to1 in*/ 0, 0, 0, 0);
		...
		// else if(i == 65){
			/*** row 0 ***///
			// mop32(OP_LDW, 0, 0, LMM[0], PE_out[0], /*ALU in*/ 0,0,PE_out[12][0],PE_out[12][8], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			// mop32(OP_LDW, 0, 0, LMM[1], PE_out[1], /*ALU in*/ 0,0,PE_out[12][9],PE_out[12][10], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			// mop32(OP_LDW, 0, 0, LMM[2], PE_out[2],/*ALU in*/ 0,0,PE_out[13][7],PE_out[13][8], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			// mop32(OP_LDW, 0, 0, LMM[3], PE_out[3],/*ALU in*/ 0,0,PE_out[13][9],PE_out[13][10], /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			/*** row 1 ***///
		...
		// }
		// else if(i == 66){
			// mop32(OP_STW, 0, 0, LMM[0], PE_out[0], /*ALU in*/ PE_out[12][0],PE_out[12][1], 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			// mop32(OP_STW, 0, 0, LMM[1], PE_out[1], /*ALU in*/ PE_out[13][0],PE_out[13][1], 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			// mop32(OP_STW, 0, 0, LMM[2], PE_out[2], /*ALU in*/ PE_out[14][0],PE_out[14][1], 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
			// mop32(OP_STW, 0, 0, LMM[3], PE_out[3], /*ALU in*/ PE_out[15][0],PE_out[15][1], 0, 0, /*BUFF 16to1 in*/ 0, 0, 0, 0, /*BUFF 8to1 in*/ 0, 0, 0, 0);
		// }
		// else{
			/*** row 0 ***///
			// if( i == 1) {
